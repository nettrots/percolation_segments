...
%% intersection of parralel
L = 0.1;
eps = 0.0001;
c1 = (((X3-X1).^2+(Y3-Y1).^2).^0.5 + ((X3-X2).^2+(Y3-Y2).^2).^0.5-L)<eps;
c2 = (((X4-X1).^2+(Y4-Y1).^2).^0.5 + ((X4-X2).^2+(Y4-Y2).^2).^0.5-L)<eps;
c= c1+c2 ;
c=c.*PAR_B;

% Arrange output.
out.intAdjacencyMatrix = INT_B + c;
